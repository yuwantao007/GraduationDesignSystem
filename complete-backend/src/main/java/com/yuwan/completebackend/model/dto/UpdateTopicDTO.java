 ...
 */
@Data
@Schema(description = "更新课题请求参数")
public class UpdateTopicDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = 1L;

    @Size(max = 100, message = "课题名称长度不能超过100个字符")
